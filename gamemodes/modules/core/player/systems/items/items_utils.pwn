...
ItemCategory(type) {
	new category[128];
	switch(type) {
        case 0: format(category, sizeof(category), "Inv�lido");
		case 1: format(category, sizeof(category), "Itens gerais");
		case 2: format(category, sizeof(category), "Itens comest�veis");
		case 3: format(category, sizeof(category), "Itens beb�veis");
		case 4: format(category, sizeof(category), "Itens gerais");
		case 5: format(category, sizeof(category), "Itens de evento");
        case 6: format(category, sizeof(category), "Itens de fac��es");
