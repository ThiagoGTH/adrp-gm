...
CMD:aceitarcumprimento(playerid)
{
	...
	switch (pInfo[playerid][pGreetingOffer]) {
		case 1: {
			...
			ApplyAnimation(userid, "GANGS", "hndshkaa", 4.0, 0, 0, 0, 0, 0, 1);
		}
		case 2:
		{
			ApplyAnimation(playerid, "GANGS", "hndshkba", 4.0, 0, 0, 0, 0, 0, 1);
			ApplyAnimation(userid, "GANGS", "hndshkba", 4.0, 0, 0, 0, 0, 0, 1);
		}
		case 3:
		{
			ApplyAnimation(playerid, "GANGS", "hndshkda", 4.0, 0, 0, 0, 0, 0, 1);
			ApplyAnimation(userid, "GANGS", "hndshkda", 4.0, 0, 0, 0, 0, 0, 1);
		}
		case 4:
		{
			ApplyAnimation(playerid, "GANGS", "hndshkea", 4.0, 0, 0, 0, 0, 0, 1);
			ApplyAnimation(userid, "GANGS", "hndshkea", 4.0, 0, 0, 0, 0, 0, 1);
		}
		case 5:
		{
			ApplyAnimation(playerid, "GANGS", "hndshkfa", 4.0, 0, 0, 0, 0, 0, 1);
			ApplyAnimation(userid, "GANGS", "hndshkfa", 4.0, 0, 0, 0, 0, 0, 1);
		}
		case 6:
		{
			ApplyAnimation(playerid, "GANGS", "prtial_hndshk_biz_01", 4.0, 0, 0, 0, 0, 0, 1);
			ApplyAnimation(userid, "GANGS", "prtial_hndshk_biz_01", 4.0, 0, 0, 0, 0, 0, 1);
		}
  	}
...
CMD:acenar(playerid, params[])
{
	...
	switch (type) {
		...
		case 3: ApplyAnimation(playerid, "ON_LOOKERS", "wave_loop", 4.1, 1, 0, 0, 0, 0, 1);
	}
	return 1;
}