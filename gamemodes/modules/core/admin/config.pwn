...
Dialog:configSys(playerid, response, listitem, inputtext[]){
    if(response){
        if(listitem == 0){ // MOBÍLIAS [OK]
            ...
            Dialog_Show(playerid, showInfoFurniture, DIALOG_STYLE_TABLIST_HEADERS, "Gerenciar > Mobílias", string, "Selecionar", "Voltar");
            return true;
        }
            ...
            Dialog_Show(playerid, showInfoInt, DIALOG_STYLE_TABLIST_HEADERS, "Gerenciar > Interiores", string, "Selecionar", "Voltar");
            return true;
        }

        else if(listitem == 3){ // VEÍCULOS
            ...
            Dialog_Show(playerid, showAdmins, DIALOG_STYLE_TABLIST_HEADERS, "Gerenciar > Administradores", string, "Remover", "Voltar");
            return true;
        }
    }
    return true;
...
Dialog:addInfoFurniture1(playerid, response, listitem, inputtext[]){
    if(response){
        ...
        Dialog_Show(playerid, addInfoFurniture2, DIALOG_STYLE_INPUT, "Gerenciar > Mobílias > Adicionar mobília", "Digite o nome da categoria para a mobília criada:", "Adicionar", "Voltar");
...
Dialog:showAdmins(playerid, response, listitem, inputtext[]){
    if(response){
        if(!strcmp(inputtext, "Adicionar administrador", true)){ // Adicionar
            Dialog_Show(playerid,  addAdmin1, DIALOG_STYLE_INPUT, "Gerenciar > Administradores > Adicionar", "Digite o nome de usuário que deseja adicionar a equipe:", "Adicionar", "Voltar");            
        } else {
...
Dialog:addAdmin1(playerid, response, listitem, inputtext[]){
    if(response){
        ...
        Dialog_Show(playerid, addAdmin2, DIALOG_STYLE_INPUT, "Gerenciar > Administradores > Adicionar", "Digite o nível do cargo do administrador:", "Adicionar", "Voltar");
        cache_delete(result);
    } else {
