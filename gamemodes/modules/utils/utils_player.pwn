...
Num aspecto geral, esse mÛdulo È dedicado ‡s funÁıes e utilidades p˙blicas que sejam interessantes a v·rios outros mÛdulos, mas que n„o
sejam, necessariamente, pertecentes a um sistema especÌfico. S„o funÁıes ˙teis e, se podemos cham·-las assim, 'gerais'.
...
// Armazenar a vari·vel de nome do jogador diretamente na string, ao invÈs de ter que terceirizar essa necessidade.
...
// FunÁıes nativas de banimento e kick ignoram obrigatoriamente a aÁ„o diretamente anterior, mas um timer anula a falha.
