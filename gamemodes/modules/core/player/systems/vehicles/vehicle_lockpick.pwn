...
CMD:quebrartrava(playerid) {
	...
	GetVehicleParamsEx(VehicleLockedID[playerid], Engine[playerid], Lights[playerid], Alarm[playerid], DoorsLockPick[playerid], Bonnet[playerid], Boot[playerid], Objective[playerid]);
...
hook OnPlayerConnect(playerid) {
	...
	PlayerTextDrawUseBox(playerid, LockText[0], 1);
	...
	PlayerTextDrawUseBox(playerid, LockText[2], 1);
	PlayerTextDrawFont(playerid, LockText[2], 4);
	PlayerTextDrawSetProportional(playerid, LockText[2], 1);
	...
	PlayerTextDrawUseBox(playerid, LockText[3], 1);
	PlayerTextDrawFont(playerid, LockText[3], 4);
	PlayerTextDrawSetProportional(playerid, LockText[3], 1);
	...
	PlayerTextDrawUseBox(playerid, LockText[4], 1);
	PlayerTextDrawFont(playerid, LockText[4], 4);
	PlayerTextDrawSetProportional(playerid, LockText[4], 1);
	...
	PlayerTextDrawUseBox(playerid, LockText[5], 1);
	PlayerTextDrawFont(playerid, LockText[5], 4);
	PlayerTextDrawSetProportional(playerid, LockText[5], 1);
	...
	PlayerTextDrawUseBox(playerid, LockText[6], 1);
	PlayerTextDrawFont(playerid, LockText[6], 4);
	PlayerTextDrawSetProportional(playerid, LockText[6], 1);
	...
	PlayerTextDrawUseBox(playerid, LockText[7], 1);
        ...
        if(LockUse[playerid] == true)
        {
            if(LockProgress < LockLocation[playerid]-(LockSize[playerid]+1) || LockProgress > LockLocation[playerid]+(LockSize[playerid]+2))
			{
                ...
                if(LockCount[playerid] == 4)
				{
					...
					if(DoorsLockPick[playerid] == 0) return SetVehicleParamsEx(VehicleLockedID[playerid], Engine[playerid], Lights[playerid], Alarm[playerid], 1, Bonnet[playerid], Boot[playerid], Objective[playerid]), SendServerMessage(playerid, "Você trancou o veículo.");
					SetVehicleParamsEx(VehicleLockedID[playerid], Engine[playerid], Lights[playerid], Alarm[playerid], 0, Bonnet[playerid], Boot[playerid], Objective[playerid]), SendServerMessage(playerid, "Você destrancou o veículo.");
				}
			} else {
...
forward LockpickTimer(playerid); public LockpickTimer(playerid) {
	...
	if(LockCount[playerid] == 4 && LockProgress > 428.9) {
    	...
    	if(Correct[playerid] != 5) {
			SetVehicleParamsEx(VehicleLockedID[playerid], Engine[playerid], Lights[playerid], 1, DoorsLockPick[playerid], Bonnet[playerid], Boot[playerid], Objective[playerid]);
		...
		if(DoorsLockPick[playerid] == 0) {
			...
			SendServerMessage(playerid, "Você usou o lockpick e o veículo foi trancado.");
			Correct[playerid] = 0;
			return true;
		}
		SetVehicleParamsEx(VehicleLockedID[playerid], Engine[playerid], Lights[playerid], Alarm[playerid], 0, Bonnet[playerid], Boot[playerid], Objective[playerid]);
		SendServerMessage(playerid, "Você usou o lockpick e o veículo foi aberto.");
		Correct[playerid] = 0;
	}
	return true;
}
