...
/*    SetPlayerToFacePlayer(playerid, targetid);
	...
	ApplyAnimation(playerid, "BLOWJOBZ", "BJ_Car_Start_P", 1.0, true, true, true, false, 0, 1);
	ApplyAnimation(targetid, "BLOWJOBZ", "BJ_Car_Start_W", 1.0, true, true, true, false, 0, 1);
...
public BlowJob(playerid, userid, step) {
	switch(step) {
	    case 0:
	    {
			ApplyAnimation(userid, "BLOWJOBZ", "BJ_Car_Loop_P", 2.0, true, true, true, false, 0, 1);
			ApplyAnimation(playerid, "BLOWJOBZ", "BJ_Car_Loop_W", 2.0, true, true, true, false, 0, 1);
            SetTimerEx("BlowJob", 10000, false, "ddd", playerid, userid, 1);
	    }
	    case 1:
	    {
			ApplyAnimation(userid, "BLOWJOBZ", "BJ_Car_End_P", 2.0, 0, 1, 1, 0, 0, 1);
			ApplyAnimation(playerid, "BLOWJOBZ", "BJ_Car_End_W", 2.0, true, true, true, false, 0, 1);
